...
public class Level_02_Apply_BasePage_I {
	...
	public void TC_02_Register_Invalid_Email() {
		...
		basePage.sendkeyToElement(driver, "//input[@id='Email']", "4534##$@456");
		...
		Assert.assertEquals(basePage.getElementText(driver, "//div[@class='page-body']//li"), "Wrong email");
	...
	public void TC_06_Register_Invalid_Confirm_Password() {
		...
		basePage.sendkeyToElement(driver, "//input[@id='Email']", emailAddress);
		basePage.sendkeyToElement(driver, "//input[@id='Password']", "123456");
		basePage.sendkeyToElement(driver, "//input[@id='ConfirmPassword']", "123411");
