...
public class HomePageUI {
	...
	public static final String HEADER_HEADER_TEXTBOX_BY_NAME = "//div[@class='qgrd-header-text' and text()='%s']//parent::div//following-sibling::input";
	...
	public static final String ROW_VALUE_BY_NAME = "//td[@data-key='females' and text()='%s']/following-sibling::td[@data-key='country' and text()='%s']/following-sibling::td[@data-key='males' and text()='%s']/following-sibling::td[@data-key='total' and text()='%s']";
